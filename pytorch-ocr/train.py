...
def main(conf, logger):
    ...
    'inner_channel': 96, 
    'k': 50, 
    'backbone': {'name': 'det_mobilenet_v3', 
    ...
    'num_layers': 2, 
    'bidirectional': True, 
    'backbone': {'name': 'rec_mobilenet_v3', 
                'pre_trained_dir': None, 
                'multiplier': 0.5, 
                'use_se': False}
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config",
                        default="./config/train/det.yml",
                        # default="./config/train/rec.yml",
                        help="配置文件路径")
    det_conf_path = parser.parse_args().config
    # print(det_conf_path)   # ./config/train/det.yml
